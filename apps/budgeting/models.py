...
class UserDefaultBudgetLine(BaseModel):
    """Mapping of default budget lines enabled by a user."""
    user = models.ForeignKey(
        User, related_name='user_default_budget_lines', on_delete=models.PROTECT)
    line = models.ForeignKey(
        DefaultBudgetLine, related_name='user_default_budget_lines', on_delete=models.PROTECT)
    enabled = models.BooleanField(default=True)
...
class UserBudgetLine(BaseModel):
    ...
    user = models.ForeignKey(
        User, related_name='user_budget_lines', on_delete=models.PROTECT)
